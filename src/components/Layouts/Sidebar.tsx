                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-50 ml-[5px] flex-none" src="assets/images/cham-logo.png" alt="logo" />
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <NavLink to="/cms" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/gallery" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Gallery')}</span>
                                            </div>
                                        </NavLink>
                                        <NavLink to="/forms" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="group-hover:!text-primary shrink-0" />
